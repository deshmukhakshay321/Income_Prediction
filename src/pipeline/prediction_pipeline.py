...
#2 create function for load a object
#3 create custom class based upon our dataset
#create fucntion to convert into dataframe with the help of Dict
...
class CustomClass:
    ...
    def get_data_frame(self):
        try:
            temp={'age':[self.age],'workclass':[self.workclass],

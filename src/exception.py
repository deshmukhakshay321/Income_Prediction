...
#exc_tb= excecution try block , starts execution from first line and for all lines,
#exe_info= execution information
#f_code = where exception started
#co_filename= applies to all files
